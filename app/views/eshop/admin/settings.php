...
<form method="post" enctype="multipart/form-data">
	<table class="table table-striped table-advance table-hover">
		...
		<?php if($type == "slider_images"):?>
			...
			<?php if($action == "show"):?>
				<thead>
					<tr><th>Header 1 Text</th><th>Header 2 Text</th><th>Main Message</th><th>Product Link</th><th>Product Image</th><th>Action</th></tr>
				</thead>
				<tbody>
					<?php if(isset($rows) && is_array($rows)):?>
						<?php foreach($rows as $row):?>
							...
							<tr>
								...
								<td>
									<a href="<?=ROOT?>admin/settings/slider_images?action=delete=<?=$row->id?>">
